...
@section('title'){{ trans('app.ir_cgo') }} - {{ trans('app.site_title') }}@endsection
  ...
  <section class="geo" style="height: 170px;">
    ...
    <div class="container">
      <div class="breadcrumbs breadcrumbs_white">
        ...
        /
        <span>{{ trans('app.ir_cgo') }}</span>
      </div>

      <h1 class="page-title">{{ trans('app.ir_cgo') }}</h1>
    </div>
  ...
  <div class="container" style="margin-top: 50px;">
    ...
    <form method="GET" action="{{ route('infosys.search') }}" class="filter filter_expertise form">
      ...
      <div class="filter__version form__field">
        ...
        <input type="hidden" name="search_type" id="search_type" value="ircgo">
      </div>
    </form>
