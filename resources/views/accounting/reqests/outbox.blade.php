...
@section('title')Исходящие - {{ trans('app.myreqests') }}@endsection
...
<main class="content">
  ...
  <div class="container">
    ...
    <h1 class="page-title">Исходящие</h1>
    ...
    @else
      <div class="info-box-error" style="margin-bottom: 5px;">В разделе <b>Исходящие</b> данные отсутствуют</div>
    @endif
