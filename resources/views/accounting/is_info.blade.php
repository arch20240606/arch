  ...
  <div class="container">
    ...
    <div class="is-info">
      <div class="is-info__header">
        ...
        <h2 class="is-info__header-title">{{ $is->name }}</h2>
      </div>
      <div class="is-info__body">
        <div class="is-info__left is-info__col">
          ...
          <div class="is-info__row" style="background: rgba(243, 248, 250, 0.30);">
            ...
            <p class="value value_green">{{ $is->filledPercentage }}%</p>
          </div>
          <div class="is-info__row" style="background: rgba(243, 248, 250, 0.30);">
      ...
      <div class="is-menu-navigation">
        <div class="is-menu">
          ...
          <ul class="is-menu__list">
            ...
            <li class="is-menu__item" data-id="11">
              ...
              <span class="is-menu__item-count">{{$isapp->count()}}</span>
            </li>
            <li class="is-menu__item" data-id="12">
              ...
              <span class="is-menu__item-count">{{$isop->count()}}</span>
            </li>
            <li class="is-menu__item" data-id="13">
              ...
              <span class="is-menu__item-count">{{$isfunc->count()}}</span>
            </li>
        ...
        <div class="is-menu-content" data-id="1" style="display: block;">
          ...
          <table class="is-table">
            ...
            <tr>
              ...
              <td>
                <p><b>
                  @if ($is->status == "5cf4c17ce8912824cdc2cb70") 
                    Не функционирует
                  @elseif ($is->status == "5cf4c175e8912824cdc2cb6f") 
                    Функционирует
                  @else
                    Нет данных
                  @endif
              ...
              <td>
                <div class="is-checkboxes">
                  <label class="toggle-checkbox">
                    <input disabled type="checkbox" @if ( $is->available_on_the_ETS_GO == "true" ) checked @endif>
                    <span></span>
                    <p>Доступен в ЕТС ГО</p>
                  </label>
                  <label class="toggle-checkbox">
                    <input disabled type="checkbox" @if( $is->available_on_the_LAN == "true") checked @endif>
                    <span></span>
                    <p>Доступен в ЛВС</p>
                  </label>
                  <label class="toggle-checkbox">
                    <input disabled type="checkbox" @if( $is->Internet_access == "true") checked @endif>
                    <span></span>
                    <p>Доступен в Интернет</p>
                  </label>
                  <label class="toggle-checkbox">
                    <input disabled type="checkbox" @if( $is->is_transboundary == "true") checked @endif>
                    <span></span>
                    <p>Трансграничный</p>
                  </label>
                  <label class="toggle-checkbox">
                    <input disabled type="checkbox" @if( $is->available_on_the_IP_VPN == "true") checked @endif>
                    <span></span>
            ...
            <tr>
              ...
              <td></td>
              <td>
                <p><b>{{ date( 'd.m.Y', strtotime($is->startVersionDateTime) ) }}</b></p>
                <p>Регистрационный номер</p>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td></td>
              <td>
                <p><b>{{ date( 'd.m.Y', strtotime($is->endVersionDateTime) ) }}</b></p>
        ...
        <div class="is-menu-content" data-id="4">
          ...
          <table class="is-table">
            <tr>
              ...
              <td>
                <p>
                  <b>{{ $is->functionalCoverageComplexity }}</b>
                  <span class="tooltip">
                    <span class="tooltip__content">
                      <span>
                        <b>1) Малый</b><br>
        ...
        <div class="is-menu-content" data-id="5">
          ...
          <table class="is-table">
            ...
            <tr>
              ...
              <td>
                <p>
                  <b>{{ $is->dataStreamsSignificance }}</b>
                  <span class="tooltip">
                    <span class="tooltip__content">
                      <span>
                        <b>1) Отсутствует</b><br>
        ...
        <div class="is-menu-content" data-id="6">
          ...
          <table class="is-table">
            ...
            <tr>
              ...
              <td>
                <p>
                  <b>{{ $is->functionalCoverageCriticality }}</b>
                  <span class="tooltip">
                    <span class="tooltip__content">
                      <span>
        ...
        <div class="is-menu-content" data-id="7" >
          ...
          <table class="is-table">
            ...
            <tr>
              ...
              <td>
                <p>
                  <b>{{ $is->AppDataStorageArchitecture }}</b>
                  <span class="tooltip">
                    <span class="tooltip__content">
                      <span>
            ...
            <tr>
              ...
              <td></td>
              <td>
                <p><b>{{ $is->AppNodeArchitecture }}</b></p>
        ...
        <div class="is-menu-content" data-id="11" >
          <h2 class="is-content-title">Имущественные и авторские права</h2>
            <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
              ...
              @foreach($isapp as $item)
              <tr>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->name}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color:#1e32c6;"><a>{{ $item->gosorg ? $item->gosorg->name : '' }}</a></td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->RelationStartDate}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->endVersionDateTime}}</td>
              </tr>
              @endforeach
          </table>
        </div>
        ...
        <div class="is-menu-content" data-id="12" >
          ...
          <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
            ...
            @foreach($isop as $item)
            <tr>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->name}}</td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color:#1e32c6;"><a>{{ $item->funcComp ? $item->funcComp->name : '' }}</a></td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->LifecycleOperationStartDate}}</td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->LifecycleOperationEndDate}}</td>
            </tr>
            @endforeach
        </table>
        </div>
        ...
        <div class="is-menu-content" data-id="13" >
          ...
          <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
            ...
            @foreach($isfunc as $item)
            <tr>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->name}}</td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color:#1e32c6;"><a>{{ $item->ComponentPurpose}}</a></td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->ComponentType}}</td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color: red;">{{ $item->functions}}</td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->ComponentStartDate}}</td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->ComponentEndDate}}</td>
            </tr>
            @endforeach
        </table>
        </div>
        ...
        <div class="is-menu-content" data-id="16" >
          ...
          <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
            ...
            @foreach($istech as $item)
            <tr>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->name}}</td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color:#1e32c6;"><a>{{ $item->funcComp ? $item->funcComp->name : '' }}</a></td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->TechnologyStartDate}}</td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->TechnologyEndDate}}</td>
            </tr>
            @endforeach
        </table>
        </div>
        ...
        <div class="is-menu-content" data-id="17" >
          ...
          <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
            ...
            @foreach($isrole as $item)
            <tr>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color:#1e32c6;"><a>{{ $item->funcComp ? $item->funcComp->name : '' }}</a></td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->name}}</td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->userCirc ? $item->userCirc->caption : '' }}</td>
            </tr>
            @endforeach
        </table>
        </div>
        ...
        <div class="is-menu-content" data-id="18" >
          ...
          <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
            ...
            @foreach($isdocs as $item)
            <tr>
            <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color:#1e32c6;">
                <a style="display: inline-block; padding: 8px; font-size: 10px; background-color:#2f43da; border-radius: 8px; color:#F3F8FA">{{$item->statusDoc}}</a>
                <a style="padding: 8px; font-size: 10px; background-color:#01ae2c; border-radius: 8px; color:#F3F8FA">{{$item->language}}</a>
                <a>{{ str_replace($item->portalTypeDoc, '', $item->getFullCaption()) }}</a>
            </td>          
              {{-- <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->getFullCaption()}}</td> --}}
            </tr>
            @endforeach
        </table>
        </div>
    ...
    <div class="is-tab-content" data-id="2">
      ...
      <table class="table table_is">
        ...
        <tbody>
          @foreach($isappdata as $item)
          <tr>
            <td class="table__name">
              {{-- <a href="#">{{}}</a> --}}
            </td>
            <td>{{$item->name}}</td>
            <td>{{$item->DataEntityNameEng}}</td>
            <td>
    ...
    <div class="is-tab-content" data-id="5">
        ...
        <div style="overflow-x: auto;">
              <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
                ...
                @foreach($isCont as $item)
                <tr>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->name}}</td>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color:#1e32c6;"><a>{{ $item->AggreementNumber}}</a></td>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->AggreementProvider}}</td>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color: red;">{{ $item->AggreementCustomer}}</td>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd;"></td>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->AggreementPlannedAmount}}</td>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->AggreementActualAmount}}</td>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->AggreementBudgetProgrammID}}</td>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd;"></td>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->AggreementBudgetProgrammSpecID}}</td>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->AggreementDate}}</td>
    ...
    <div class="is-tab-content" data-id="3">
      ...
      <div style="overflow-x: auto;">
            <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
              ...
              @foreach($iscont as $item)
              <tr>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->role}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color:#1e32c6;"><a>{{ $item->name}}</a></td>
                ...
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->CPUQuant}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->failover}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">
                ...
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->RAMSize}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->storagesize}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->storageutilization}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->CPUAvgLoad}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->CPUMaxLoad}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->RAMAvgLoad}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->RAMMaxLoad}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->startDate}}</td>
                <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">{{$item->endDate}}</td>
              </tr>
              @endforeach
          </table>
        </div>
