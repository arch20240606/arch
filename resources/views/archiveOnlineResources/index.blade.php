...
<main class="content">
  ...
  <div class="container">
    ...
    <div class="breadcrumbs">
      ...
      /
      <a href="{{ route('archiveOnlineResources.index') }}">Архивные Интернет-ресурсы</a>
    </div>
...
<form class="filter filter_expertise form" method="GET" action="{{ route('archiveOnlineResources.search') }}">
