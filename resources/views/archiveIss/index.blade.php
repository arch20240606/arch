...
<main class="content">
  ...
  <div class="container">
    ...
    <div class="breadcrumbs">
      ...
      /
      <a href="{{ route('archiveIss.index') }}">Архивные Информационные Системы</a>
    </div>
...
{{-- <form class="filter filter_expertise form" method="GET" action="{{ route('archiveIss.search') }}">
...
<div class="filter-container" style="display: flex; align-items: center; gap: 130px;">
  ...
  {{-- <form class="form" method="GET" action="{{ route('archiveIss.index') }}">
    <label for="status" style="margin-left: 200px">Фильтр по статусу:</label>
    <div style="margin-top: 10px; width: 300px">
        <select name="owner">
            <option value="all">Выберите владельца</option>
