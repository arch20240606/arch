...
<main class="content">
  ...
  <div class="container">
    ...
    <div class="filter-title-container" style="display: flex; align-items: center;">
      <div class="filter-title">Запросы на экспертизу: В работе</div>
      <a href="{{ route('expertise.in_work.inProcess') }}" style="display: inline-block; margin-left: auto; padding: 8px 15px; background-color: #4682c2; color: white; text-align: center; text-decoration: none; border-radius: 5px; margin-top: 0;">Запросы на экспертизу: В работе неотписанные</a>
  </div>
