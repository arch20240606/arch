...
<main class="content">
  ...
  <div class="container">
    ...
    <div class="filter-title-container" style="display: flex; align-items: center;">
      ...
      <a href="{{ route('expertise.in_work') }}" style="display: inline-block; margin-left: auto; padding: 8px 15px; background-color: #4682c2; color: white; text-align: center; text-decoration: none; border-radius: 5px; margin-top: 0;">Запросы на экспертизу: В работе</a>
  </div>
