  ...
  <div class="conclusion_si" style="display: none;">
    <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
        <div style="display: flex; align-items: center;">
            ...
            <select id="status_concl" name="status_concl" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #f9f9f9; cursor: pointer; width: 200px;" disabled>
                ...
                <option value="Положительно" {{ $concl->status_concl == 'Положительно' ? 'selected' : '' }}>Положительно</option>
                <option value="Отрицательно" {{ $concl->status_concl == 'Отрицательно' ? 'selected' : '' }}>Отрицательно</option>
                <option value="Условно-положительное (данное заключение будет являться положительным при условии устранения представленных замечаний)" {{ $concl->status_concl == 'Условно-положительное (данное заключение будет являться положительным при условии устранения представленных замечаний)' ? 'selected' : '' }}>Условно-положительное (данное заключение будет являться положительным при условии устранения представленных замечаний)</option>
            </select>
        </div>
    </div>
    ...
    <div class="conclusion_si" style="display: none;">
      <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
        ...
        <div style="display: flex; align-items: center;">
          ...
          <textarea class="editable" name="concl_1" id="concl_1" readonly style="margin-left: 105px; width: 700px; height: 100px; border: 1px solid #ccc;">{{$concl->concl_1}}</textarea>
        </div>
      </div>
    </div>
    ...
    <div class="conclusion_si" style="display: none;">
      <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
        ...
        <div style="display: flex; align-items: center;">
            <p style="margin-right: 20px; color: #666;">Перечень документов</p>
            <textarea class="editable" name="concl_2" id="concl_2" readonly style="margin-left: 105px; width: 700px; height: 100px; border: 1px solid #ccc;">{{$concl->concl_2}}</textarea>
        </div>
      </div>
    </div>
    ...
    <div class="conclusion_si" style="display: none;">
      <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <textarea class="editable" name="concl_3" id="concl_3" readonly style="margin-left: 105px; width: 700px; height: 100px; border: 1px solid #ccc;">{{$concl->concl_3}}</textarea>
        </div>
      </div>
    </div>
      ...
      <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
          ...
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_4" id="concl_4" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                  <option value="Имеется" {{ $concl->concl_4 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                  <option value="Отсутствует" {{ $concl->concl_4 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                  <option value="Не требуется" {{ $concl->concl_4 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
          </div>
        ...
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_5" id="concl_5" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_5 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_5 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_5 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
        </div>
          ...
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_6" id="concl_6" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_6 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_6 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_6 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
        ...
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_7" id="concl_7" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_7 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_7 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_7 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
        </div>
        <hr style="border-top: 2px solid #333;">
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_8" id="concl_8" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_8 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_8 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_8 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
        </div>
        <hr style="border-top: 2px solid #333;">
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_9" id="concl_9" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled disabled>
                <option value="Имеется" {{ $concl->concl_9 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_9 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_9 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
        </div>
      </div>
    </div>
      ...
      <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
        ...
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_10" id="concl_10" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_10 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_10 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_10 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
        </div>
        <hr style="border-top: 2px solid #333;">
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_11" id="concl_11" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_11 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_11 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_11 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
        </div>
        <hr style="border-top: 2px solid #333;">
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_12" id="concl_12" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_12 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_12 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_12 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
        </div>
      </div>
    <div>
        ...
        <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
          ...
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_13" id="concl_13" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                  <option value="Имеется" {{ $concl->concl_13 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                  <option value="Отсутствует" {{ $concl->concl_13 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                  <option value="Не требуется" {{ $concl->concl_13 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
          </div>
    ...
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_14" id="concl_14" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_14 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_14 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_14 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
    <hr style="border-top: 2px solid #333;">
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_15" id="concl_15" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_15 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_15 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_15 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
    <hr style="border-top: 2px solid #333;">
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_16" id="concl_16" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_16 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_16 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_16 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
    <hr style="border-top: 2px solid #333;">
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_17" id="concl_17" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_17 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_17 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_17 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
    <hr style="border-top: 2px solid #333;">
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_18" id="concl_18" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_18 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_18 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_18 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
    <hr style="border-top: 2px solid #333;">
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_19" id="concl_19" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_19 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_19 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_19 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
    <hr style="border-top: 2px solid #333;">
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_20" id="concl_20" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_20 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_20 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_20 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
    <hr style="border-top: 2px solid #333;">
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_21" id="concl_21" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_21 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_21 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_21 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
    <hr style="border-top: 2px solid #333;">
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_22" id="concl_22" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_22 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_22 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_22 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
    <hr style="border-top: 2px solid #333;">
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_23" id="concl_23" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_23 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_23 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_23 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
    <hr style="border-top: 2px solid #333;">
    <div style="display: flex; align-items: center; margin-bottom: 10px;">
      ...
      <select name="concl_24" id="concl_24" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
        <option value="Имеется" {{ $concl->concl_24 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
        <option value="Отсутствует" {{ $concl->concl_24 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
        <option value="Не требуется" {{ $concl->concl_24 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
      </select>
    </div>
  </div>
</div>
      ...
      <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
        ...
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
          ...
          <select name="concl_25" id="concl_25" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
            <option value="Имеется" {{ $concl->concl_25 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
            <option value="Отсутствует" {{ $concl->concl_25 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
            <option value="Не требуется" {{ $concl->concl_25 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
          </select>
        </div>
        ...
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
          ...
          <select name="concl_26" id="concl_26" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
            <option value="Имеется" {{ $concl->concl_26 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
            <option value="Отсутствует" {{ $concl->concl_26 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
            <option value="Не требуется" {{ $concl->concl_26 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
          </select>
        </div>
        ...
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
          ...
          <select name="concl_27" id="concl_27" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
            <option value="Имеется" {{ $concl->concl_27 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
            <option value="Отсутствует" {{ $concl->concl_27 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
            <option value="Не требуется" {{ $concl->concl_27 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
          </select>
        </div>
        ...
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
          ...
          <select name="concl_28" id="concl_28" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
            <option value="Имеется" {{ $concl->concl_28 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
            <option value="Отсутствует" {{ $concl->concl_28 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
            <option value="Не требуется" {{ $concl->concl_28 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
          </select>
        </div>
        ...
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
          ...
          <select name="concl_29" id="concl_29" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
            <option value="Имеется" {{ $concl->concl_29 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
            <option value="Отсутствует" {{ $concl->concl_29 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
            <option value="Не требуется" {{ $concl->concl_29 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
          </select>
        </div>
      </div>    
      <div>
        ...
        <div class="conclusion_si" style="display: none;">
          ...
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_30" id="concl_30" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
              <option value="Имеется" {{ $concl->concl_30 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
              <option value="Отсутствует" {{ $concl->concl_30 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
              <option value="Не требуется" {{ $concl->concl_30 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
          </div>
          ...
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_31" id="concl_31" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
              <option value="Имеется" {{ $concl->concl_31 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
              <option value="Отсутствует" {{ $concl->concl_31 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
              <option value="Не требуется" {{ $concl->concl_31 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
          </div>
          ...
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_32" id="concl_32" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
              <option value="Имеется" {{ $concl->concl_32 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
              <option value="Отсутствует" {{ $concl->concl_32 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
              <option value="Не требуется" {{ $concl->concl_32 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
          </div>
          ...
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_33" id="concl_33" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
              <option value="Имеется" {{ $concl->concl_33 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
              <option value="Отсутствует" {{ $concl->concl_33 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
              <option value="Не требуется" {{ $concl->concl_33 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
          </div>
          ...
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_34" id="concl_34" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
              <option value="Имеется" {{ $concl->concl_34 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
              <option value="Отсутствует" {{ $concl->concl_34 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
              <option value="Не требуется" {{ $concl->concl_34 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
          </div>
          ...
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_35" id="concl_35" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
              <option value="Имеется" {{ $concl->concl_35 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
              <option value="Отсутствует" {{ $concl->concl_35 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
              <option value="Не требуется" {{ $concl->concl_35 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
          </div>
          ...
          <div style="display: flex; align-items: center; margin-bottom: 10px;">
            ...
            <select name="concl_36" id="concl_36" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
              <option value="Имеется" {{ $concl->concl_36 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
              <option value="Отсутствует" {{ $concl->concl_36 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
              <option value="Не требуется" {{ $concl->concl_36 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
            </select>
          </div>
        </div>
        <div>
          ...
          <div class="conclusion_si" style="display: none;">
            <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
              ...
              <select name="concl_37" id="concl_37" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_37 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_37 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_37 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_38" id="concl_38" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_38 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_38 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_38 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_39" id="concl_39" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_39 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_39 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_39 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_40" id="concl_40" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_40 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_40 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_40 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_41" id="concl_41" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_41 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_41 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_41 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
          </div>
          ...
          <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_42" id="concl_42" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_42 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_42 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_42 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_43" id="concl_43" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_43 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_43 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_43 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_44" id="concl_44" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_44 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_44 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_44 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_45" id="concl_45" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_45 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_45 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_45 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_46" id="concl_46" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_46 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_46 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_46 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_47" id="concl_47" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_47 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_47 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_47 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
          </div>
          ...
          <div style="padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin-bottom: 20px;">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_48" id="concl_48" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_48 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_48 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_48 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_49" id="concl_49" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_49 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_49 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_49 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_50" id="concl_50" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_50 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_50 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_50 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_51" id="concl_51" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_51 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_51 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_51 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_52" id="concl_52" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_52 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_52 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_52 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
          </div> 
        <div>
          ...
          <div class="conclusion_si" style="display: none;">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_53" id="concl_53" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_53 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_53 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_53 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_54" id="concl_54" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_54 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_54 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_54 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_55" id="concl_55" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_55 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_55 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_55 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_56" id="concl_56" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_56 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_56 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_56 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
          </div>
          </div>
          ...
          <div class="conclusion_si" style="display: none;">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 10px;">
              ...
              <select name="concl_57" id="concl_57" style="padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #fff; cursor: pointer; width: 200px;" disabled>
                <option value="Имеется" {{ $concl->concl_57 == 'Имеется' ? 'selected' : '' }}>Имеется</option>
                <option value="Отсутствует" {{ $concl->concl_57 == 'Отсутствует' ? 'selected' : '' }}>Отсутствует</option>
                <option value="Не требуется" {{ $concl->concl_57 == 'Не требуется' ? 'selected' : '' }}>Не требуется</option>
              </select>
            </div>
          </div>
          ...
          <div style="padding: 20px; border: 1px solid #ccc;border-radius: 10px; margin-bottom: 20px;">
              ...
              <div style="display: flex; align-items: center;">
                ...
                <textarea class="editable" name="concl_58" id="concl_58" readonly style="margin-left: 105px; width: 700px; height: 100px; border: 1px solid #ccc;">{{$concl->concl_58}}</textarea>
              </div>
          </div>
          ...
          <div style="padding: 20px; border: 1px solid #ccc;border-radius: 10px; margin-bottom: 20px;">
              ...
              <div style="display: flex; align-items: center;">
                <p style="margin-right: 20px; color: #666;">Заключение</p>
                <textarea class="editable" name="concl_59" id="concl_59" readonly style="margin-left: 105px; width: 700px; height: 100px; border: 1px solid #ccc;">{{$concl->concl_59}}</textarea>
              </div>
          </div>
      </div>
      <div>
