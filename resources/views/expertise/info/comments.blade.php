...
@if (auth()->check() && auth()->user()->hasRole('ROLE_UO_EXPERTISE_DANA')) 
  @if (auth()->check() && auth()->user()->hasRole('ROLE_UO_EXPERTISE_DANA') && $expertise->accept_uo_reviewer == 1)
  ...
  @endif   
@if (auth()->check() && auth()->user()->hasRole('ROLE_UO_EXPERTISE_DANA') && $expertise->accept_uo_reviewer == 0)
...
<div class="buttons-wrapper">
  @if (auth()->user()->hasRole('ROLE_SI_EXPERTISE_REVIEWER') && $expertise->send_to_si_reviewers == 1)
      ...
      <input type="hidden" name="expertise_id" id="expertise_id" value="{{ $expertise->id }}">
      {{-- <label for="signer">Выбрать Подписывающего</label> --}}
  ...
  <div class="buttons-wrapper">
    ...
    @if (auth()->user()->hasRole('ROLE_UO_EXPERTISE_DANA') && $expertise->send_to_uo == 1 && $expertise->accept_uo_reviewer == 0 ) 
    <input type="hidden" name="expertise_id" id="expertise_id" value="{{ $expertise->id }}">
    ...
    @if (auth()->user()->hasRole('ROLE_UO_EXPERTISE_DANA') && $expertise->accept_uo_reviewer == 1)
      <input type="hidden" name="expertise_id" id="expertise_id" value="{{ $expertise->id }}">
...
<div class="buttons-wrapper">
  ...
  {{-- @if (auth()->user()->hasRole('ROLE_GO_EXPERTISE_CONFIRMER') && $expertise->send == 1)
      <button  class="btn" onclick="approveGo({{$expertise->id}})" style="font-size: 14px; background: #00317B;">Согласовать</button>
  @endif --}}

  {{-- @if (auth()->user()->hasRole('ROLE_UO_EXPERTISE_DANA') && $expertise->send_to_uo == 1 && $expertise->accept_uo_reviewer == 0 ) 
    <input type="hidden" name="expertise_id" id="expertise_id" value="{{ $expertise->id }}">
    <button class="btn" onclick="sendToUoReviewer()" style="font-size: 14px; background: #00317B;">Отправить к исполнителю</button>
  @endif --}}

  {{-- @if (auth()->user()->hasRole('ROLE_UO_EXPERTISE_REVIEWER') && $expertise->send_to_uo_reviewer == 1) 
    <input type="hidden" name="expertise_id" id="expertise_id" value="{{ $expertise->id }}">
    <button class="btn" style="font-size: 14px; background: #b90404;">Вернуть</a>
    <button class="btn" id="accept_uo_reviewer" name="accept_uo_reviewer" style="font-size: 14px; background: #00317B;">Принять</button>
  @endif --}}
