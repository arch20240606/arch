...
<main class="content">
        ...
        <div class="is-menu-content" data-id="16" >
          ...
          <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
            ...
            <tr>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;"><?php echo e($item->name); ?></td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color:#1e32c6;"><a><?php echo e($item->funcComp ? $item->funcComp->name : ''); ?></a></td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">Не забудь в базе</td>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd;">Не забудь в базе</td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </table>
          ...
          <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
            ...
            <tr>
              <td style="padding: 8px; text-align: left; border: 1px solid #ddd; color:#1e32c6;">
                <a style="padding: 8px; margin-bottom: 5px; font-size: 10px; background-color:#2f43da; border-radius: 8px; color:#F3F8FA"><?php echo e($item->statusDoc); ?></a>
                <a style="padding: 8px; margin-bottom: 5px; font-size: 10px; background-color:#01ae2c; border-radius: 8px; color:#F3F8FA"><?php echo e($item->language); ?></a>
    ...
    <div class="is-tab-content" data-id="5">
        ...
        <div style="overflow-x: auto;">
              <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
                ...
                <?php $__currentLoopData = $iscon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td style="padding: 8px; text-align: left; border: 1px solid #ddd;"><?php echo e($item->name); ?></td>
  ...
  <div class="is-tab-content" data-id="8">
    <h2 class="is-content-title">Классификатор заполненный ГО в ИС</h2>
    <h4 class="is-content-title">Данная форма предназначена для осуществления классификации информационной системы в соответствии с Правилами классификации объектов информатизации утвержденных Приказом и.о. Министра по инвестициям и развитию Республики Казахстан от 28 января 2016 года № 135.</h4>
    <div style="overflow-x: auto;">
          <table style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; border: 1px solid #ddd;">
            <tr>
                <div class="is-menu" style="width: 1200px; height: 1200px;">
                  <ul class="is-menu__list">
                    <li class="is-menu__item is-menu__item_active" data-id="1">
                      <span class="is-menu__item-title">Классификатор заполненный ГО в ИС</span>
                    </li>
                  </ul>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/accounting/is_info.blade.php ENDPATH**/ ?>