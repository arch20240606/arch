...
<main class="content">
  ...
  <div class="container">
    ...
    <h1 class="page-title"><?php echo e(trans('app.catalog')); ?></h1> <?php echo e(trans('app.data_edit')); ?>
    ...
    <?php if(!empty($errorMsg)): ?>
      <div class="info-box-error" style="margin-bottom: 5px;"><b><?php echo e(trans('app.reg_error')); ?>:</b> <?php echo $errorMsg; ?></div>
    <?php endif; ?>


    <?php if( $passport->discarted == 1): ?>
      <div class="info-box-error">Паспорт был отклонен <?php echo e(date('d.m.Y в H:i:s', strtotime( $passport->discarted_at ))); ?> с комментарием: <?php echo e($passport->comment); ?></div>
    <?php endif; ?>
    ...
    <div class="is-info">
      ...
      <form class="form" enctype="multipart/form-data" method="POST" action="<?php echo e(route('datacatalog.update', ['datacatalog' => $passport->id])); ?>">
        <?php echo csrf_field(); ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="table__status">
                ...
                <select id="go_select" name="go_select" required>
                  <option value="" selected><?php echo e(trans('app.dc_name_go_select')); ?></option>
                  ...
                  <option value="<?php echo e($government->id); ?>" <?php if($passport->goverment_id == $government->id): ?> selected <?php endif; ?>><?php echo e($government->$name_go); ?></option>
            ...
            <tr>
              ...
              <td class="table__status">
                <select id="data_used" name="data_used" required>
                  <option value="0" <?php if($passport->data_used == 0): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_data_used_select')); ?></option>
                  <option value="1" <?php if($passport->data_used == 1): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_republic')); ?></option>
                  <option value="2" <?php if($passport->data_used == 2): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_local')); ?></option>
                </select>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status">
                <select id="data_enter" name="data_enter" required>
                  <option value="0" <?php if($passport->data_enter == 0): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_data_enter_select')); ?></option>
                  <option value="1" <?php if($passport->data_enter == 1): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_data_enter_letter')); ?></option>
                  <option value="2" <?php if($passport->data_enter == 2): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_data_enter_electro')); ?></option>
                  <option value="3" <?php if($passport->data_enter == 3): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_data_enter_combo')); ?></option>
                </select>
              </td>
            </tr>
              ...
              <td class="table__status">
                <div class="is-checkboxes">
                  <label class="toggle-checkbox">
                    <input type="checkbox" id="data_first" name="data_first" <?php if($passport->data_first == "on"): ?> checked <?php endif; ?>>
                    <span></span>
                    <p><?php echo e(trans('app.dc_data_first')); ?></p>
                  </label>
                  <label class="toggle-checkbox">
                    <input type="checkbox" id="data_agregate" name="data_agregate" <?php if($passport->data_agregate == "on"): ?> checked <?php endif; ?>>
                    <span></span>
            ...
            <tr>
              ...
              <td class="table__status">
                <div class="is-checkboxes">
                  <label class="toggle-checkbox">
                    <input type="checkbox" name="data_access_only" <?php if($passport->data_access_only == "on"): ?> checked <?php endif; ?>>
                    <span></span>
                    <p><?php echo e(trans('app.dc_data_access_only')); ?></p>
                  </label>
                  <label class="toggle-checkbox">
                    <input type="checkbox" name="data_access_free" <?php if($passport->data_access_free == "on"): ?> checked <?php endif; ?>>
                    <span></span>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e($passport->users_npa); ?>" class="form__field" id="users_npa" name="users_npa" type="text" maxlength="1500" required></td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e($passport->data_source); ?>" class="form__field" id="data_source" name="data_source" type="text" maxlength="590" required></td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e($passport->data_source_fact); ?>" class="form__field" id="data_source_fact" name="data_source_fact" type="text" maxlength="590" required></td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status">
                <select id="object_description" name="object_description" required>
                  <option value="0" <?php if($passport->object_description == 0): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_object_description_select')); ?></option>
                  <option value="1" <?php if($passport->object_description == 1): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_object_description_fiz')); ?></option>
                  <option value="2" <?php if($passport->object_description == 2): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_object_description_ur')); ?></option>
                  <option value="3" <?php if($passport->object_description == 3): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_object_description_imush')); ?></option>
                  <option value="4" <?php if($passport->object_description == 4): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_object_description_result')); ?></option>
                  <option value="5" <?php if($passport->object_description == 5): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_object_description_oxrana')); ?></option>
                  <option value="6" <?php if($passport->object_description == 6): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_object_description_blaga')); ?></option>
                </select>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status">
                <select id="interval_update" name="interval_update" required>
                  <option value="0" <?php if($passport->interval_update == 0): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_interval_update_select')); ?></option>
                  <option value="1" <?php if($passport->interval_update == 1): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_interval_update_no')); ?></option>
                  <option value="2" <?php if($passport->interval_update == 2): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_interval_update_need')); ?></option>
                  <option value="3" <?php if($passport->interval_update == 3): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_interval_update_data')); ?></option>
                  <option value="4" <?php if($passport->interval_update == 4): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_interval_update_refresh')); ?></option>
                  <option value="5" <?php if($passport->interval_update == 5): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_interval_update_npa')); ?></option>
                </select>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status">
                <select id="graphic_update" name="graphic_update" required>
                  <option value="0" <?php if($passport->graphic_update == 0): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_graphic_update_select')); ?></option>
                  <option value="1" <?php if($passport->graphic_update == 1): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_graphic_update_time')); ?></option>
                  <option value="2" <?php if($passport->graphic_update == 2): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_graphic_update_data')); ?></option>
                  <option value="3" <?php if($passport->graphic_update == 3): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_graphic_update_npa')); ?></option>
                  <option value="4" <?php if($passport->graphic_update == 4): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_graphic_update_no')); ?></option>
                </select>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e($passport->update_rules); ?>" class="form__field" id="update_rules" name="update_rules" type="text" maxlength="590" required></td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status">
                <select id="geo" name="geo">
                  <option value="0" <?php if($passport->geo == 0): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_geo_select')); ?></option>
                  <option value="1" <?php if($passport->geo == 1): ?> selected <?php endif; ?>><?php echo e(trans('app.yes')); ?></option>
                  <option value="2" <?php if($passport->geo == 2): ?> selected <?php endif; ?>><?php echo e(trans('app.no')); ?></option>
                </select>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status">
                <select id="geo_type" name="geo_type" required disabled>
                  <option value="0" <?php if($passport->geo_type == 0): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_geo_type_select')); ?></option>
                  <option value="1" <?php if($passport->geo_type == 1): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_geo_type_dot')); ?></option>
                  <option value="2" <?php if($passport->geo_type == 2): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_geo_type_line')); ?></option>
                  <option value="3" <?php if($passport->geo_type == 3): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_geo_type_poly')); ?></option>
                  <option value="4" <?php if($passport->geo_type == 4): ?> selected <?php endif; ?>><?php echo e(trans('app.no')); ?></option>
                </select>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e($passport->npa_list); ?>" class="form__field" id="npa_list" name="npa_list" type="text" maxlength="590" required></td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e($passport->npa_list_reglament); ?>" class="form__field" id="npa_list_reglament" name="npa_list_reglament" maxlength="590" type="text" required></td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e($passport->npa_list_rules); ?>" class="form__field" id="npa_list_rules" name="npa_list_rules" maxlength="1500" type="text" required></td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status">
                <select id="data_class" name="data_class">
                  <option value="0" <?php if($passport->data_class == 0): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_data_class_select')); ?></option>
                  <option value="1" <?php if($passport->data_class == 1): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_data_class_1')); ?></option>
                  <option value="2" <?php if($passport->data_class == 2): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_data_class_2')); ?></option>
                  <option value="3" <?php if($passport->data_class == 3): ?> selected <?php endif; ?>><?php echo e(trans('app.dc_data_class_3')); ?></option>
                </select>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e(date( 'Y-m-d', strtotime($passport->date_publication) )); ?>" name="date_publication" id="date_publication" type="date"></td>
            </tr>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e($passport->info_object); ?>" class="form__field" id="info_object" name="info_object" type="text" maxlength="4000" required></td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e($passport->object_used); ?>" class="form__field" id="object_used" name="object_used" type="text" maxlength="590" required></td>
            </tr>
            ...
            <tr>
              ...
              <td class="table__status"><input value="<?php echo e($passport->object_change); ?>" class="form__field" id="object_change" name="object_change" type="text" maxlength="590" required></td>
            </tr>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span data-hint="<?php echo e(trans('app.dc_structure_file_t')); ?>"><img style="width: 25px;" src="/assets/images/question.png"></span></td>
              <td class="table__name">
                ...
                <?php if( !empty($passport->file_excel_upload) ): ?>
                <div style="margin-top: 10px; padding-left: 28px;">Ранее загруженный файл: <a href="/storage/<?php echo e($passport->file_excel_upload); ?>"><?php echo e($passport->file_excel); ?></a></div>
                <?php endif; ?>
              </td>
            </tr>
          </tbody>
        ...
        <div style="margin-top: 25px;"><?php echo e($passport->comment); ?><br><br><?php echo e($passport->comment_go); ?></div>
                  ...
                  <div class="is-checkboxes-list">
                    ...
                    <?php $__currentLoopData = $approve_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $approve_user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <?php else: ?>
                        ...
                        <?php if( in_array($approve_user->id, $allApproveUsers) ): ?>
                        <label class="toggle-checkbox">
                          <input type="checkbox" name="approve_users[]" value="<?php echo e($approve_user->id); ?>" checked>
                          <span></span>
                          <p><?php echo e($approve_user->surname); ?> <?php echo e($approve_user->name); ?> <?php echo e($approve_user->middlename); ?></p>
                        </label>
                        <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/datacatalog/index_edit.blade.php ENDPATH**/ ?>