...
<div class="buttons-wrapper">
   ...
   <?php if(auth()->user()->hasRole('ROLE_GO_EXPERTISE_SIGNER') && $expertise->send_to_go_signer == 1): ?>
    ...
    <?php if(auth()->user()->hasRole('ROLE_GO_EXPERTISE_CONFIRMER') && $expertise->send == 1): ?>
        <button  class="btn" id='approve_go' name="approve_go" onclick="approveGo(<?php echo e($expertise->id); ?>)" style="display:block; : 14px; background: #00317B;">Согласовать</button>
    <?php endif; ?>
...
<?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/expertise/signing/comments.blade.php ENDPATH**/ ?>