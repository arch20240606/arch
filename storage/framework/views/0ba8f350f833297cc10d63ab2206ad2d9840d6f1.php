...
<?php elseif(auth()->check() && (auth()->user()->hasRole('ROLE_UO_EXPERTISE_REVIEWER') || auth()->user()->hasRole('ROLE_KIB_EXPERTISE_EXECUTOR') || auth()->user()->hasRole('ROLE_GTS_EXPERTISE_CONFIRMER') )): ?>
    <a class="tabs__link <?php if(Route::is('expertise.in_work')): ?> tabs__link_active <?php endif; ?>" href="<?php echo e(route('expertise.in_work')); ?>">
        <span class="tabs__num" style="background: #39C07F;">0</span>
        В работе 
    </a>
...
<?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/expertise/menu.blade.php ENDPATH**/ ?>