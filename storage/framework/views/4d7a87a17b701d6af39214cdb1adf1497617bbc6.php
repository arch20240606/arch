...
// });
    ...
    document.addEventListener('click', function(event) {
        ...
        // Проверяем, была ли нажата кнопка 'Добавить подписанта'
            ...
            var label = document.createElement('label');
            label.setAttribute('for', 'signer' + selectCount);
            label.textContent = 'Выбрать подписанта';
            ...
            defaultOption.setAttribute('selected', 'selected');
            defaultOption.setAttribute('disabled', 'disabled');
            defaultOption.textContent = 'Выберите подписанта';
            select.appendChild(defaultOption);
...
<?php $__env->stopSection(); ?><?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/expertise/info/comments_scripts.blade.php ENDPATH**/ ?>