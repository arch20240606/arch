          ...
          <tr>
            ...
            <td class="table__status">
              <?php if( $passport->discarted == 1): ?>
                <span style="width: 100%" class="status status_no"><?php echo e(trans('app.tab_discart')); ?></span>
              <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/govarch.kz/docs/resources/views/datacatalog/index_draft.blade.php ENDPATH**/ ?>