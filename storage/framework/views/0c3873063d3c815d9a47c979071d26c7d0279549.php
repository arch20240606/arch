...
<main class="content">
  ...
  <div class="container">
    ...
    <h1 class="page-title"><?php echo e(trans('app.catalog')); ?></h1> Утверждение паспорта данных
    ...
    <div class="is-info">
      ...
      <form class="form" method="POST" action="<?php echo e(route('datacatalog.update', ['datacatalog' => $passport->id])); ?>">
        ...
        <div class="buttons-wrapper" style="border-top: 1px solid #e3e5ec; padding-top: 25px; margin-top: 50px;">
          ...
          <button class="btn" type="submit" id="passport_signin_accept" name="passport_signin_accept" style="font-size: 14px; background: #00317B;"><?php echo e(trans('app.tab_approve_passport')); ?></button>
          <button class="btn" type="submit" id="passport_signin_discart" name="passport_signin_discart" style="font-size: 14px; background: #bc2601;"><?php echo e(trans('app.tab_send_finalized')); ?></button>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/govarch.kz/docs/resources/views/datacatalog/index_signingedit.blade.php ENDPATH**/ ?>