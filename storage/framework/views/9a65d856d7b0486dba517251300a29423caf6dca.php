    ...
    <?php else: ?>
      ...
      <table class="table table_expertise">
        ...
        <tr>
          ...
          <th>Версия</th>
          <?php if(auth()->check() && (auth()->user()->hasRole('ROLE_UO_EXPERTISE_CONFIRMER'))): ?>
        ...
        <tbody>
          ...
          <?php $__currentLoopData = $expertises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expertise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
              ...
              <?php if(auth()->check() && (auth()->user()->hasRole('ROLE_UO_EXPERTISE_CONFIRMER'))): ?>
              <td class="table__status">
                <?php if( $expertise->send_to_uo_confirmer == 1 ): ?>
                  <span style="width: 100%; cursor: pointer;" class="status status_wait">На согласовании</span>
                <?php else: ?>
                  <span style="width: 100%; cursor: pointer;" class="status status_wait">Ожидание расмотренния</span>
                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/expertise/approve.blade.php ENDPATH**/ ?>