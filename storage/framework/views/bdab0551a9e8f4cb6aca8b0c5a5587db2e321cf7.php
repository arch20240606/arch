  ...
  <div class="container">
    ...
    <nav class="footer__menu">
      <ul class="footer__list">
        ...
        <li class="footer__item">
          <a class="footer__link" href="<?php echo e(route('budget')); ?>"><?php echo e(trans('app.budget')); ?></a>
        </li>
        <li class="footer__item">
...
</footer><?php /**PATH /var/www/govarch.kz/docs/resources/views/layouts/footer.blade.php ENDPATH**/ ?>