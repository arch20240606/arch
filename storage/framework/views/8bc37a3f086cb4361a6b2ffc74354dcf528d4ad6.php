          ...
          <?php if( $b_roadmap->getCase($b_roadmap->id)->count() > 0 ): ?>
            ...
            <?php $__currentLoopData = $b_roadmap->getCase($b_roadmap->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="is-menu-content" data-id="case_<?php echo e($case->id); ?>">
                ...
                <br>
                <span class="is-menu__item-title">Государственный орган: <span style="color: #0075ff;"><?php echo e($case->government->$names); ?></span></span>
                <br>
                    ...
                    if ( !empty($functs) ) {
                      foreach ($functs as $funct) {
                        ...
                        ?>
                          ...
                          <tr>
                            <td><a href="<?php echo e(route('businessprocess.reestr.view_bp', ['id' => $b_proccess->id])); ?>"><?php echo e($b_proccess->name); ?></a></td>
                            <td class="table__status" style="width: 76px;">
                              <?php if($b_proccess->file_as_is): ?>
                                <?php if($b_proccess->file_as_is_accept == "on"): ?>
                                  <a class="feather-green" target="_blank" href="/storage/<?php echo e($b_proccess->file_as_upload); ?>"><svg><use href="/assets/images/feather-sprite.svg#check-circle"/></svg></a>
                                <?php else: ?>
                            ...
                            <td class="table__status" style="width: 76px;">
                              <?php if($b_proccess->file_to_be): ?>
                                <?php if($b_proccess->file_to_be_accept == "on"): ?>
                                  <a class="feather-green" target="_blank" href="/storage/<?php echo e($b_proccess->file_to_be_upload); ?>"><svg><use href="/assets/images/feather-sprite.svg#check-circle"/></svg></a>
                                <?php else: ?>
                            ...
                            <td class="table__status" style="width: 76px;">
                              <?php if($b_proccess->file_program): ?>
                                <?php if($b_proccess->file_program_accept == "on"): ?>
                                  <a class="feather-green" target="_blank" href="/storage/<?php echo e($b_proccess->file_program_upload); ?>"><svg><use href="/assets/images/feather-sprite.svg#check-circle"/></svg></a>
                                <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/businessprocess/reestr.blade.php ENDPATH**/ ?>