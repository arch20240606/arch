...
<div class="buttons-wrapper">
   ...
   <?php if(auth()->user()->hasRole('ROLE_GO_EXPERTISE_SIGNER') && $expertise->send_to_go_signer == 1): ?>
    ...
    <?php if(auth()->user()->hasRole('ROLE_GO_EXPERTISE_CONFIRMER') && $expertise->send == 1): ?>
        <button id='approve_go' name="approve_go" onclick="approveGo(<?php echo e($expertise->id); ?>)" style="display:block; background: #00317B; font-size: 5px;">Согласовать</button>
    <?php endif; ?>
  ...
  <?php if(auth()->user()->hasRole('ROLE_GO_EXPERTISE_CONFIRMER') && $expertise->send == 1): ?>
      <button  class="btn" onclick="approveGo(<?php echo e($expertise->id); ?>)" style="font-size: 14px; background: #00317B;">Согласовать</button>
  <?php endif; ?>
...
<?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/expertise/signing/comments.blade.php ENDPATH**/ ?>