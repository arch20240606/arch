...
<main class="content">
  ...
  <div class="container">
    ...
    <div class="breadcrumbs">
      ...
      /
      <a href="<?php echo e(route('archiveIss.index')); ?>">Архивные Информационные Системы</a>
    </div>

    <h1>Архивные Информационные Системы</h1>
...
<div class="filter-container" style="display: flex; align-items: center; gap: 130px;">
  <form class="filter filter_expertise form" method="GET" action="<?php echo e(route('archiveIss.search')); ?>">
      ...
      <table class="table table_expertise" style="font-weight: normal; color: #000000;">
        ...
        <?php $__currentLoopData = $iss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $is): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td class="table__status"><?php echo e($is->regNumber); ?></td>
            <?php
            $date = new DateTime();
    ...
    <?php else: ?>
      <div class="info-box-error" style="margin-bottom: 5px;">В разделе <b>Архивные Информационные Системы</b> данные отсутствуют</div>
    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/archiveIss/index.blade.php ENDPATH**/ ?>