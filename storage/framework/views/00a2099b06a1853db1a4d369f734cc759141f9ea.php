...
<select id="conSelect" style="margin-bottom: 24px; padding: 8px; border: 1px solid #ccc; border-radius: 5px; background-color: #f9f9f9; cursor: pointer; width: 200px;">
  ...
  <?php endif; ?>
  <?php if(auth()->user()->hasAnyRole(['ROLE_UO_EXPERTISE_REVIEWER', 'ROLE_UO_EXPERTISE_CONFIRMER', 'ROLE_UO_EXPERTISE_SIGNER'])): ?>
...
<?php
  $conclusions = App\Models\ExpertiseConclutionSi::all(); 
  $conclusionsUo = App\Models\ExpertiseConclutionUo::all();
  $conclusionsGts = App\Models\ExpertiseConclutionGts::all();
?>
...
<?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/expertise/signing/comments_show.blade.php ENDPATH**/ ?>