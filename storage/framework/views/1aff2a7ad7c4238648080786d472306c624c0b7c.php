  ...
  <form class="form" method="POST" action="asdas">
    <div class="is-info__left is-info__col" style="width:1300px ">
      ...
      <div class="is-info__row" style="margin-top: 13px;">
        ...
        <input id="surname" name="surname" value="<?php echo e($is->type); ?>" type="text" disabled>
      </div>
      <div class="is-info__row">
        <p><b>Инвентарный номер актива</b></p>
        <input id="name" name="name" value="<?php echo e($is->assetInvNumber); ?>" type="text" disabled>
      </div>
      <div class="is-info__row">
        <p><b>Серийный номер аппаратного средства</b></p>
        <input id="middlename" name="middlename" value="<?php echo e($is->HardwareItemSerialNumber); ?>" type="text" disabled>
      </div>
      <div class="is-info__row">
        <p><b>Имя</b></p>
        <?php
        ...
        ?>
        <input id="middlename" name="middlename" value="<?php echo e($inputValue); ?>" type="text" disabled>
      </div>
      <div class="is-info__row">
        <p><b>Производитель/линейка</b></p>
        <input id="new_password" name="new_password" value="<?php echo e($is->product); ?>" type="text" disabled>
      </div>
      <div class="is-info__row">
        ...
        ?>
        <input id="new_password" name="new_password" value="<?php echo e($inputValue); ?>" type="text" disabled>
      </div>
      <div class="is-info__row">
        ...
        ?>
        <input id="new_password" name="new_password" value="<?php echo e($is->gosorg->name); ?>" type="text" disabled>
      </div>
      <div class="is-info__row">
      ...
      <div class="is-info__row">
        ...
        $inputValue = str_replace(['[', ']', '"'], '', $is->ngrs);
        ?>
        <input id="new_password" name="new_password" value="<?php echo e($is->BusinessObjectType); ?>" type="text" disabled>
      </div>
      <div class="is-info__row">
        ...
        $inputValue = str_replace(['[', ']', '"'], '', $is->ngrs);
        ?>
        <input id="new_password" name="new_password" value="<?php echo e($is->serverStorageAmount); ?>" type="text" disabled>
      </div>
      <div class="is-info__row">
        <p><b>
        ...
        $inputValue = str_replace(['[', ']', '"'], '', $is->ngrs);
        ?>
        <input id="new_password" name="new_password" value="<?php echo e($is->startVersionDateTime); ?>" type="text" disabled>
      </div>
      <div class="is-info__row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/equipment/info.blade.php ENDPATH**/ ?>