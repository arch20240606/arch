...
<main class="content">
  ...
  <div class="container">
    ...
    <div class="breadcrumbs">
      ...
      /
      <span>Опубликованные Информационные системы</span>
    </div>

    <h1 class="page-title">Опубликованные Информационные системы</h1>

    
  
   

<form class="filter filter_expertise form" method="GET" action="<?php echo e(route('publishedIss.search')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/publishedIss/index.blade.php ENDPATH**/ ?>