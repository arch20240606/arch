...
<main class="content">
  ...
  <div class="container">
    ...
    <div class="breadcrumbs">
      ...
      /
      <a href="<?php echo e(route('itProject.index')); ?>">ИКТ-проекты</a>
    </div>
...
<form class="filter filter_expertise form" method="GET" action="<?php echo e(route('itProject.search')); ?>">
    ...
    <?php if($iss->count() > 0 ): ?>
      ...
      <table class="table table_expertise" style="font-weight: normal; color: #000000;">
        ...
        <?php $__currentLoopData = $iss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $is): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td class="table__status"><?php echo e($is->idit); ?></td>
            
            <td class="table__status" style="text-align: left;"><a href="<?php echo e(route('itProject.show', ['itProject' => $is->idit])); ?>"><?php echo e($is->name); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/itProject/index.blade.php ENDPATH**/ ?>