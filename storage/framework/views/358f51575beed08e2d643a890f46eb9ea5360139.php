...
<main class="content">
  ...
  <div class="container">
    ...
    <div class="breadcrumbs">
      ...
      /
      <a href="<?php echo e(route('onlineResources.index')); ?>">Интернет-ресурсы</a>
    </div>
...
<form class="filter filter_expertise form" method="GET" action="<?php echo e(route('onlineResources.search')); ?>">
  ...
  <button class="tabs__button btn" style="border-radius: 8px 8px 8px 8px;" type="submit">Найти</button>
    ...
    <?php else: ?>
      <div class="info-box-error" style="margin-bottom: 5px;">В разделе <b>Интернет-ресурсы</b> данные отсутствуют</div>
    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/onlineResources/index.blade.php ENDPATH**/ ?>