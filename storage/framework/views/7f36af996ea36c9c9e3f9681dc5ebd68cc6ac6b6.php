...
<form class="form" method="POST" action="<?php echo e(route('expertise.store')); ?>">
  ...
  <?php $__currentLoopData = $conclusionsSi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php elseif(auth()->user()->hasRole('ROLE_GTS_EXPERTISE_REVIEWER')): ?> 
<div class="buttons-wrapper">
...
<?php elseif(auth()->user()->hasRole('ROLE_UO_EXPERTISE_REVIEWER')): ?> 
<div class="buttons-wrapper">
...
<?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/expertise/info/comments_show.blade.php ENDPATH**/ ?>