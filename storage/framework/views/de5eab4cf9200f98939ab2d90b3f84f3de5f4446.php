...
<main class="content">
  ...
  <div class="container">
    ...
    <div class="filter-title-container" style="display: flex; align-items: center;">
      ...
      <a href="<?php echo e(route('expertise.in_work.inProcess')); ?>" style="display: inline-block; margin-left: auto; padding: 8px 15px; background-color: #4682c2; color: white; text-align: center; text-decoration: none; border-radius: 5px; margin-top: 0;">Запросы на экспертизу: В работе неотписанные</a>
  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/expertise/in_work/index.blade.php ENDPATH**/ ?>