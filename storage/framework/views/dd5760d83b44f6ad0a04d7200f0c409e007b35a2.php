...
<main class="content">
  ...
  <div class="container">
    ...
    <div class="breadcrumbs">
      ...
      /
      <span>Архивные Интернет-ресурсы</span>
    </div>

    <h1 class="page-title">Архивные Интернет-ресурсы</h1>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/archiveOnlineResources/index.blade.php ENDPATH**/ ?>