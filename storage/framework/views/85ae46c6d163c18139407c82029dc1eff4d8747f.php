          ...
          <table class="is-table">
            ...
            <tr>
              ...
              <td>
                ...
                <p><b><?php echo e($it->AggreementNumber); ?></b></p>
              </td>
            </tr>
            ...
            <tr>
              <td>Поставщик<span style="color: #FF6A97">*</span></td>
              <td></td>
              <td>
                  <b>
            ...
            <tr>
              ...
              <td>
                ...
                <b>
                  Код бюджетной программы договора
                  </b>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <b>
                  Код бюджетной подпрограммы договора
                  </b>
              </td>
            </tr>

            <tr>
              <td>Код специфики бюджетной программы</td>
              <td></td>
              <td>
                <b>
                  Код специфики бюджетной программы договора
                  </b>
              </td>
            </tr>
                ...
                <div class="is-menu">
                  ...
                  <ul class="is-menu__list">
                    <li class="is-menu__item" data-id="7">
                      <span class="is-menu__item-title">Мероприятия</span>
                    </li>
                    <li class="is-menu__item" data-id="8">
                      <span class="is-menu__item-title">Документы</span>
                    </li>
                    <li class="is-menu__item" data-id="9">
                      <span class="is-menu__item-title">Связанные объекты</span>
                    </li>
                    <li class="is-menu__item" data-id="10">
                      <span class="is-menu__item-title">Информационные системы</span>
                    </li>
                    <li class="is-menu__item" data-id="11">
                      <span class="is-menu__item-title">Активы (инв. номер)</span>
                    </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/contract/con_info.blade.php ENDPATH**/ ?>