    ...
    <nav class="header__menu">
      <ul class="header__menu-list">
        <li class="header__menu-item">
          <a class="header__menu-link" href="<?php echo e(route('accounting.index')); ?>"><?php echo e(trans('app.myreqests')); ?></a>
        </li>
        <li class="header__menu-item">
...
</div><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/layouts/header_auth.blade.php ENDPATH**/ ?>