...
<main class="content">
  ...
  <div class="container">
    ...
    <?php if(Auth::user()->government_id == 24): ?>
                  ...
                  <form method="POST" action="<?php echo e(route('etalondatas.update', ['etalondata' => $domain->id])); ?>">
                    ...
                    <h2 class="is-content-title">
                      ...
                      <?php else: ?>
                        ...
                        <a class="btn" onclick="acceptDomain('<?php echo e($domain->id); ?>')" style="font-size: 14px; padding: 5px; min-width: 210px; margin-left: 50px;">
                          Утвердить домен
                        </a>
                  ...
                  <div class="tabcontent" id='f<?php echo e($domain->id); ?>00'>
                    ...
                    <div class="filter form form__field">
                      <select onchange="getDateObject(this, 'info_div_f<?php echo e($domain->id); ?>00')" id="f<?php echo e($domain->id); ?>00_o" name="f<?php echo e($domain->id); ?>00_o" required>
                        ...
                        <?php $__currentLoopData = \App\Models\DomainObjectCollection::domainObjectsMCRIAP($domain->id, 'Физ.лицо'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $objects): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="tabcontent" id='u<?php echo e($domain->id); ?>01'>
                    ...
                    <div class="filter form form__field">
                      <select onchange="getDateObject(this, 'info_div_u<?php echo e($domain->id); ?>01')" id="u<?php echo e($domain->id); ?>01_o" name="u<?php echo e($domain->id); ?>01_o" required>
                        <option value="">Выберите объект</option>
                        <?php $__currentLoopData = \App\Models\DomainObjectCollection::domainObjectsMCRIAP($domain->id, 'Юр.лицо (организация)'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $objects): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($objects->id); ?>"><?php echo e($objects->data_object); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  ...
                  <div class="tabcontent" id='o<?php echo e($domain->id); ?>02'>
                    ...
                    <div class="filter form form__field">
                      <select onchange="getDateObject(this, 'info_div_o<?php echo e($domain->id); ?>02')" id="o<?php echo e($domain->id); ?>02_o" name="o<?php echo e($domain->id); ?>02_o" required>
                        <option value="">Выберите объект</option>
                        <?php $__currentLoopData = \App\Models\DomainObjectCollection::domainObjectsMCRIAP($domain->id, 'Объект'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $objects): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($objects->id); ?>"><?php echo e($objects->data_object); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  ...
                  <div class="tabcontent" id='d<?php echo e($domain->id); ?>03'>
                    ...
                    <div class="filter form form__field">
                      <select onchange="getDateObject(this, 'info_div_d<?php echo e($domain->id); ?>03')" id="d<?php echo e($domain->id); ?>03_o" name="d<?php echo e($domain->id); ?>03_o" required>
                        <option value="">Выберите объект</option>
                        <?php $__currentLoopData = \App\Models\DomainObjectCollection::domainObjectsMCRIAP($domain->id, 'Документ'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $objects): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($objects->id); ?>"><?php echo e($objects->data_object); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
...
function acceptDomain(domain_id) {
  ...
  webSocket.onmessage = function (event) {
    ...
    if(result.responseObject) {
      ...
      $.ajax({
        url: "<?php echo e(route('etalondatas.signing.signecp')); ?>",
        method: 'POST',
        dataType: "json",
        data: {
          _verify: dataecp,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/etalondata/signing.blade.php ENDPATH**/ ?>