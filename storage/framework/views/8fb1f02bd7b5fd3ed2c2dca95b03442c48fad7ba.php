      ...
      <table class="table table_expertise" style="font-weight: normal; color: #000000;">
        ...
        <?php $__currentLoopData = $iss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $is): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td class="table__status"><?php echo e(empty($is->serverRAMAmount) ? '0 гб' : $is->serverRAMAmount . ' гб'); ?></td>
            <td class="table__status"><?php echo e(empty($is->serverStorageAmount) ? '0 гб' : $is->serverStorageAmount . ' гб'); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/equipment/index.blade.php ENDPATH**/ ?>