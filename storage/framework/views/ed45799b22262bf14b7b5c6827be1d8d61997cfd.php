...
<?php if(isset($version) && $version->version_number > 1): ?>
    ...
    <table class="is-table">
      ...
      <tr>
        ...
        <td style="padding: 12px 20px 12px 20px; color: #000000; font-size: 16px; width: 65%">
          <?php if($expertise->selected_is_for_change > 0 ): ?>
            <?php echo e($expertise->getISS($expertise->selected_is_for_change)->$names); ?>
      ...
      <tr>
        ...
        <td></td>
        <td style="padding: 12px 20px 12px 20px; color: #000000; font-size: 16px; width: 65%">
          <?php if($expertise->selected_is_for_exit > 0 ): ?>
            <?php echo e($expertise->getISS($expertise->selected_is_for_exit)->$names); ?>
  ...
  <div class="is-menu-content" data-id="1" style="display: block;">
    <table class="is-table">
      <tr>
        ...
        <td></td>
        <td style="padding: 12px 20px 12px 20px; color: #000000; font-size: 16px; width: 65%"><?php echo e($expertise->paln_integrations); ?></td>
      </tr>
    </table>
  </div>
<?php else: ?> 
...
<?php endif; ?> <?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/expertise/info/function.blade.php ENDPATH**/ ?>