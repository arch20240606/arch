<nav class="is-tabs tabs">
  ...
  <?php elseif(auth()->check() && (auth()->user()->hasRole('ROLE_UO_EXPERTISE_DANA') || auth()->user()->hasRole('ROLE_UO_EXPERTISE_REVIEWER') || auth()->user()->hasRole('ROLE_UO_EXPERTISE_SIGNER'))): ?>
    <a style="width: 25%; font-size: 16px;" class="tabs__link" href="#" data-id="6">Комментарии/Заключение</a>
  <?php endif; ?>
</nav>
...
<div class="is-tab-content" data-id="1" style="display: block;">
  <?php echo $__env->make('expertise.tabs_data.passport_edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<div class="is-tab-content" data-id="4">
  <?php echo $__env->make('expertise.tabs_data.documents_edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/expertise/tabs_for_data_edit.blade.php ENDPATH**/ ?>