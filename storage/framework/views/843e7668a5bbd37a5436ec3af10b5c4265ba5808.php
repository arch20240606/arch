      ...
      <tr>
        ...
        <td style="padding: 12px 20px 12px 20px;">
          <select id="hosting" name="hosting" required>
            <option value="Приобретение серверного оборудования" <?php if($expertise->hosting == "Приобретение серверного оборудования"): ?> selected <?php endif; ?>>Приобретение серверного оборудования</option>
            <option value="АО НИТ" <?php if($expertise->hosting == "АО НИТ"): ?> selected <?php endif; ?>>АО НИТ</option>
            <option value="АО Казахтелеком" <?php if($expertise->hosting == "АО Казахтелеком"): ?> selected <?php endif; ?>>АО Казахтелеком</option>
            <option value="Другой хостинг" <?php if($expertise->hosting == "Другой хостинг"): ?> selected <?php endif; ?>>Другой хостинг</option>
          </select>
        </td>
      </tr>
...
</div><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/expertise/tabs_data/passport_edit.blade.php ENDPATH**/ ?>