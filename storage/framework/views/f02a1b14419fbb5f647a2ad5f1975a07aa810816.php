...
<?php if(auth()->user()->hasRole('ROLE_GO_EXPERTISE_SIGNER') || auth()->user()->hasRole('ROLE_GO_EXPERTISE_EDITOR') || auth()->user()->hasRole('ROLE_GO_EXPERTISE_REVIEWER')): ?>
...
<?php if(auth()->user()->hasRole('ROLE_SI_EXPERTISE_REVIEWER') && $expertise->send_to_si_reviewers == 1): ?>
  ...
  <div class="buttons-wrapper">
    ...
    <?php if(auth()->user()->hasRole('ROLE_GO_EXPERTISE_CONFIRMER') && $expertise->send == 1): ?>
        <button  class="btn" id='approve_go' name="approve_go" style="display:block; : 14px; background: #00317B;">Согласовать</button>
    <?php endif; ?>
    ...
    <?php if(auth()->user()->hasRole('ROLE_SI_EXPERTISE_SIGNER') && $expertise->send_to_si_signer == 1): ?>
      ...
      <button class="btn" id="" name=""  style="font-size: 14px; background: #00317B;">Отправить в УО</button>
    <?php endif; ?>
  </div>
</form>
...
<?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/expertise/info/comments.blade.php ENDPATH**/ ?>