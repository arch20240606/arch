          ...
          <?php $__currentLoopData = $expertises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expertise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
              ...
              <?php if($expertise->user_id == Auth::user()->id): ?>
               <td class="table__name"><a href="<?php echo e(route('expertise.edit', ['expertise' => $expertise->id])); ?>"><?php echo e($expertise->it_project->$names); ?></a></td>
              <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/expertise/draft.blade.php ENDPATH**/ ?>