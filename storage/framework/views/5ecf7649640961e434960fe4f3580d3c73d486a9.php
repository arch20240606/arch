                  ...
                  <td style="border: 1px solid rgb(72, 69, 69); padding: 8px;">
                    <select style="width: 100%; box-sizing: border-box;">
                      <?php $__currentLoopData = $iss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $is): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option><?php echo e($is->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </td>
                  <td style="border: 1px solid rgb(72, 69, 69); padding: 8px;">
            ...
            <div class="is-menu-content" data-id="11">
              ...
              <table style="border-collapse: collapse; overflow: hidden;">
                ...
                <tr>
                  ...
                  <td style="border: 1px solid rgb(72, 69, 69); padding: 8px;">
                    <select style="width: 100%; box-sizing: border-box;">
                      <?php $__currentLoopData = $gos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gosorg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option><?php echo e($gosorg->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </td>
            ...
            <div class="is-menu-content" data-id="16">
              <table style="border-collapse: collapse; overflow: hidden;">
                ...
                <tr>
                  ...
                  <td style="border: 1px solid rgb(72, 69, 69); padding: 8px;">
                    <select style="width: 100%; box-sizing: border-box;">
                      <?php $__currentLoopData = $funccomp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $funccomps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option><?php echo e($funccomps->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </td>
                  <td style="border: 1px solid rgb(72, 69, 69); padding: 12px; font-size: 14px;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/accounting/reqests/create.blade.php ENDPATH**/ ?>