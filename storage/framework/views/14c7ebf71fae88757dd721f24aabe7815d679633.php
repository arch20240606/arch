        ...
        <tbody>
          ...
          <?php $__currentLoopData = $expertises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expertise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
              ...
              <?php if(auth()->check() && (auth()->user()->hasRole('ROLE_GO_EXPERTISE_CONFIRMER') || auth()->user()->hasRole('ROLE_GO_EXPERTISE_SIGNER'))): ?>
              <td class="table__status">
                <?php if( $expertise->go_approve == 1 ): ?>
              ...
              <td class="table__status">
                <?php if( $expertise->send_to_go_signer == 1 ): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/expertise/outbox.blade.php ENDPATH**/ ?>