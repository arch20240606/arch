...
<?php $__env->startSection('title'); ?><?php echo e(trans('app.d_agreement')); ?>: <?php echo e(trans('app.catalog')); ?> - <?php echo e(trans('app.site_title')); ?><?php $__env->stopSection(); ?>
...
<main class="content">
  ...
  <div class="container">
    ...
    <?php if( $passports->isEmpty() ): ?>
      <div class="notice">В разделе <b><?php echo e(trans('app.d_agreement')); ?></b> отсутствуют данные</div>
    <?php else: ?>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="table__status">
            <?php if($passport->accepted == 1 && $passport->accepted_go != 1): ?>
              <span style="width: 100%;" class="status status_edit"><?php echo e(trans('app.tab_onsign')); ?></span>
            <?php elseif($passport->accepted_go == 1 && $passport->accepted == 1): ?>
              <span style="width: 100%;" class="status status_yes"><?php echo e(trans('app.tab_onapproved')); ?></span>
            <?php elseif($passport->discarted_go == 1): ?>
              <span style="width: 100%;" class="status status_no"><?php echo e(trans('app.tab_onfinalized')); ?></span>
            <?php else: ?>
              <span style="width: 100%;" class="status status_wait"><?php echo e(trans('app.tab_onagreed')); ?></span>
            <?php endif; ?>
          </td>
          ...
          <td class="table__status">
            ...
            <?php if($passport->accepted != 1): ?>
              <div style="display: flex; position: center;">
                ...
                <a href="<?php echo e(route('datacatalog.agreementedit', ['id' => $passport->id])); ?>" class="feather" title="<?php echo e(trans('app.edit')); ?>">
                  <svg>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/govarch.kz/docs/resources/views/datacatalog/index_agreement.blade.php ENDPATH**/ ?>