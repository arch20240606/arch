    ...
    <div class="container">
      ...
      <div class="intro__inner">
        ...
        <div class="intro__buttons">
          ...
          <?php elseif(auth()->check() && (auth()->user()->hasRole('ROLE_UO_EXPERTISE_REVIEWER') || auth()->user()->hasRole('ROLE_SI_EXPERTISE_CONFIRMER') || auth()->user()->hasRole('ROLE_KIB_EXPERTISE_CONFIRMER'))): ?>
          <a class="intro__buttons-item btn btn_icon btn_white" href="<?php echo e(route('expertise.in_work')); ?>">
            <svg>
              <use xlink:href="/assets/images/sprite.svg#check-fill"></use>
            </svg>
...
<?php /**PATH C:\Users\user\Desktop\новый портал\www\resources\views/layouts/content_main_auth.blade.php ENDPATH**/ ?>