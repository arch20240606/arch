    ...
    <tr>
      ...
      <td style="width: 70%; padding: 12px 20px 12px 20px;">
        <select id="selected_is_for_change" name="selected_is_for_change" required>
          <option value="0">Выберите информационную систему</option>
          ...
          <option value="<?php echo e($is->id); ?>" <?php if($expertise->selected_is_for_change == $is->id): ?> selected <?php endif; ?>><?php echo e($is->$names); ?></option>
    ...
    <tr>
      ...
      <td style="width: 70%; padding: 12px 20px 12px 20px;">
        <select id="selected_is_for_exit" name="selected_is_for_exit" required>
          ...
          <?php $__currentLoopData = $iss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $is): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($is->id); ?>" <?php if($expertise->selected_is_for_exit == $is->id): ?> selected <?php endif; ?>><?php echo e($is->$names); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </td>
    </tr>
...
<div class="is-menu-content" data-id="1" style="display: block;">
  <table class="is-table">
    <tr>
      ...
      <td></td>
      <td style="width: 70%; padding: 12px 20px 12px 20px;"><input value="<?php echo e($expertise->paln_integrations); ?>" id="paln_integrations" name="paln_integrations" type="text" minlength="2" maxlength="500" autofocus></td>
    </tr>
  </table>
</div><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/expertise/tabs_data/function_edit.blade.php ENDPATH**/ ?>