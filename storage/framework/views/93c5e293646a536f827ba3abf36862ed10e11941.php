  ...
  <div class="container">
    ...
    <div class="is-info">
      ...
      <form class="form" enctype="multipart/form-data" method="POST" action="<?php echo e(route('expertise.store')); ?>">
        ...
        <?php echo $__env->make('expertise.tabs_for_data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <!-- это важные переменные -->
        <input type="hidden" id="it_project_id" name="it_project_id" value="<?php echo e($it_project_id); ?>">
        <input type="hidden" id="type_project" name="type_project" value="<?php echo e($type_project); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\НОВЫЙ ПОРТАЛ\www\resources\views/expertise/create_data.blade.php ENDPATH**/ ?>