...
class ArchiveOnlineResourcesController extends Controller
{
    /* Auth constructor */
    ...
    public function index()
{
    $iss = InformationSystemCollection::where('bpStatus', 'LIKE', 'archive%')
        ->where('app_software_type', 'LIKE', 'internet_resource%')
        ->orderBy('idis', 'asc')
        ->paginate(20);

    return View::make('archiveOnlineResources.index', [
        'iss' => $iss
    ]);
}
    ...
    public function search(Request $request)
    {
        ...
        return view('archiveOnlineResources.index', ['iss' => $iss]);
    }
