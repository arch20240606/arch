...
class PublishedIssController extends Controller
{
    /* Auth constructor */
...
{
    $iss = BusinessObject::orderBy('idBis', 'asc')
        ->paginate(20);

    return View::make('bussinessObject.index', [
        'iss' => $iss
    ]);
}
    ...
    public function show($id)
    {
         ...
         */
        $is = BusinessObject::where('idBis', $id)->first();
        return View::make('bussinessObject.info', [
           'is' => $is
        ]);
    }
