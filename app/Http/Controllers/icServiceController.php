...
class icServiceController extends Controller
{
    /* Auth constructor */
...
{
    $iss = InformationSystemCollection::where('app_software_type', 'LIKE', 'IC_service%')
        ->orderBy('idis', 'asc')
        ->paginate(20);
    ...
    public function search(Request $request)
    {
        ...
        return view('icService.index', ['iss' => $iss]);
    }
