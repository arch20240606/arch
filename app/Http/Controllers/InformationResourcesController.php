...
use App\Models\InformationResources;
...
class InformationResourcesController extends Controller
{
    /* Auth constructor */
...
{
    $iss = InformationResources::orderBy('idIas', 'asc')
        ->paginate(20);

    return View::make('informationResources.index', [
        'iss' => $iss
    ]);
}
    ...
    //     $iss = ITProject::where(function ($q) use ($query) {
    //         $q->where('name', 'LIKE', "%$query%");
    //     })
    //     ->paginate(20);
    
    //     return view('bussinessObject.index', ['iss' => $iss]);
    // }
    ...
    public function show($id)
    {
         ...
         */
        $is = InformationResources::where('idIas', $id)->first();
        return View::make('informationResources.info', [
           'is' => $is
        ]);
    }
    ...
    //     return View::make('icService.index', [
    //        'iss' => $iss
    //     ]);
    // }
    ...
    // public function iss()
    // {
    //     $iss = BusinessObject::paginate(20);

    //     return View::make('itProject.index', [
    //        'iss' => $iss
    //     ]);
    // }
}
