...
{
    $iss = Integration::orderBy('idIn', 'asc')
        ->paginate(20);

    return View::make('integration.index', [
        'iss' => $iss
    ]);
}
    ...
    public function search(Request $request)
    {
        ...
        $iss = Integration::where(function ($q) use ($query) {
            $q->where('purpose', 'LIKE', "%$query%");
        })
        ->paginate(20);
    
        return view('integration.index', ['iss' => $iss]);
    }
    ...
    public function show($id)
    {
         ...
         */
        $it = Integration::where('idIn', $id)->first();
        return View::make('integration.con_info', [
           'it' => $it
        ]);
    }
